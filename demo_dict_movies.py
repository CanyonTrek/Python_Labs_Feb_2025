#! /usr/bin/python
# Author: BersuitX 
# Description: This about script How to create, and grow, and shrink
# dictionaires (Undereoed,Collections with UNIQUE keys)
...
movies['erik'] = ['star wars', 'blue velvet', 'edge of tomorrow']
